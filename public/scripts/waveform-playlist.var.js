	    ...
	    value: function load() {
	      ...
	      return new Promise(function (resolve, reject) {
	        ...
	        xhr.addEventListener('load', function (e) {
						if(xhr.status === 404) {
							showErrorMessage('Track/s failed to load. Not Found');
							console.log(xhr);
						}
	          var decoderPromise = _get(_class.prototype.__proto__ || Object.getPrototypeOf(_class.prototype), 'fileLoad', _this2).call(_this2, e);
	  ...
	  _createClass(_class, [{
	    ...
	    */
	    ...
	    value: function renderControls(data) {
	      ...
	      }, [(0, _h2.default)('header', [this.name]), (0, _h2.default)('div.btn-group', [(0, _h2.default)('span.btn.btn-outline-secondary.btn-sm' + muteClass, {
	        onclick: function onclick() {
	          _this2.ee.emit('mute', _this2);
	        }
	      }, ['Mute']), (0, _h2.default)('span.btn.btn-outline-secondary.btn-sm' + soloClass, {
	        onclick: function onclick() {
